...
// CreateTicket ...
func (s *ServiceDesk) CreateTicket(ctx context.Context, model *CreateTicketRequest) (*CreateTicketResponse, error) {
	...
	if res.StatusCode != http.StatusCreated {
		...
		return nil, ErrDefaultFreshDesk
	}
...
// GetTicket ...
func (s *ServiceDesk) GetTicket(ctx context.Context, id int) (*GetTicketResponse, error) {
	...
	if res.StatusCode == http.StatusNotFound {
		return nil, ErrFreshDeskTicketNotFound
	}
...
// FilterTickets ...
func (s *ServiceDesk) FilterTickets(ctx context.Context, model *FilterTicketsRequest) (*FilterTicketsResponse, error) {
	...
	var result *FilterTicketsResponse
