...
var (
	...
	//	ErrAPICNPJJa ...
	ErrAPICNPJJa = grok.NewError(http.StatusInternalServerError, "internal server error")
	//	ErrAPICNPJJaURL ...
	ErrAPICNPJJaURL = grok.NewError(http.StatusInternalServerError, "invalid URL")
	//	ErrAPICNPJJaNotFound ...
	ErrAPICNPJJaNotFound = grok.NewError(http.StatusNotFound, "not found")
	//	ErrAPICNPJJaNotEnoughCredits ...
	ErrAPICNPJJaNotEnoughCredits = grok.NewError(http.StatusNotFound, "not enough credits")
	//	ErrAPICNPJJaHandler ...
	ErrAPICNPJJaHandler = grok.NewError(http.StatusNotFound, "handler error")
	// ErrInvalidToken ...
