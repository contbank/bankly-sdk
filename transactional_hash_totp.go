...
//TransactionalHash...
func (p *Pix) TransactionalHash(ctx context.Context, transactional TransactionalHashRequest, identifier string) (*TransactionalHash, error) {
...
func (p *Pix) TransactionalHashValidate(ctx context.Context, transactional TransactionalHash, identifier string) (*TransactionalHashValidateResponse, error) {
	requestID, _ := ctx.Value("Request-Id").(string)
