...
func (c *DocumentAnalysis) SendDocumentAnalysis(ctx context.Context,
	request models.DocumentAnalysisRequest) (*models.DocumentAnalysisResponse, error) {
	...
	if resp.StatusCode == http.StatusCreated || resp.StatusCode == http.StatusAccepted {
		var bodyResp *models.DocumentAnalysisRequestedResponse
	...
	return nil, errors.ErrSendDocumentAnalysis
}

// FindDocumentAnalysis ...
func (c *DocumentAnalysis) FindDocumentAnalysis(ctx context.Context, documentNumber string,
	documentAnalysisToken string) (*models.DocumentAnalysisResponse, error) {
	...
	if err != nil {
		...
		return nil, errors.ErrInvalidAPIEndpoint
	}
	...
	if resp.StatusCode == http.StatusOK {
		var response []*models.BanklyDocumentAnalysisResponse
		...
		return models.ParseDocumentAnalysisResponse(documentNumber, response[0]), nil
	}
	...
	return nil, errors.ErrGetDocumentAnalysis
}

// getDocumentAnalysisAPIEndpoint ...
func (c *DocumentAnalysis) getDocumentAnalysisAPIEndpoint(document string, resultLevel *models.ResultLevel,
	...
	u.Path = path.Join(u.Path, models.DocumentAnalysisPath)
...
func createSendImagePayload(request models.DocumentAnalysisRequest) (*bytes.Buffer, *multipart.Writer, error) {
