...
func (s *TransfersTestSuite) SetupTest() {
	...
	s.session = session
	s.transfers = transfers.NewTransfers(httpClient, *s.session)
...
func createInternalTransferRequest(amount int64, from AccountToTest, to AccountToTest) models.TransfersRequest {
	...
	return models.TransfersRequest{
		Amount:      amount,
...
func createSenderRequest(branch string, account string, document string, name string) *models.SenderRequest {
	return &models.SenderRequest{
		Branch:   branch,
		Account:  account,
		Document: document,
		Name:     name,
...
func createRecipientRequest(bankCode string, branch string, account string,
	document string, name string) *models.RecipientRequest {
	return &models.RecipientRequest{
		BankCode:             bankCode,
		Branch:               branch,
		Account:              account,
		Document:             document,
		Name:                 name,
		TransfersAccountType: models.CheckingAccount,
	}
}
